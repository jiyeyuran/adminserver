...
type User struct {
	...
	Ctime       *util.DateTime `json:"ctime,omitempty"`    // 创建时间
}
...
type RoomInfo struct {
	...
	Ctime             *util.DateTime `json:"ctime,omitempty"  sql:"index:ri_ctime"` // 创建时间
}
...
type ConferenceInfo struct {
	...
	Ctime           *util.DateTime `json:"ctime,omitempty" sql:"index:ci_ctime"`        // 开始时间
...
type RecordInfo struct {
	...
	Ctime        *util.DateTime `json:"ctime,omitempty"`        // 开始时间
}
