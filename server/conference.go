		...
		if recording := req.Recording; recording != nil {
			...
			if isStreaming {
				...
				s.DB().InsertInto(app.RecordTableName).
					Columns(app.RecordUidCol, app.RecordConferenceIdCol, app.RecordRoomNameCol, app.RecordStreamUrlCol).
	...
	case MUC_ROOM_RECORDING_STOP:
		if recording := req.Recording; recording != nil {
			...
			if len(recording.Streaming) > 0 {
				...
				s.DB().InsertInto(app.RecordTableName).
					Columns(app.RecordUidCol, app.RecordConferenceIdCol, app.RecordRoomNameCol,
